Page({
  ...
  getGoods: function(a) {
    ...
    getApp().core.showLoading({
      ...
      success: function(a) {
        0 == a.code && (getApp().core.hideLoading(), t.data.goods = t.data.goods.concat(a.data.list), t.setData({
          goods: t.data.goods,
          page: a.data.page,
  ...
  switchNav: function(a) {
    ...
    if (e.setData({
      ...
      var o = this.systemInfo.windowWidth,
        d = a.currentTarget.offsetLeft,
        p = this.data.scrollLeft;
      p = o / 2 < d ? d : 0, e.setData({
        scrollLeft: p
      })
    } else {
      for (var s = e.data.cat, n = !0, g = 0; g < s.length; ++g)
        if (s[g].id === a.currentTarget.id) {
          n = !1, 1 <= g ? e.setData({
            toView: s[g - 1].id
          }) : e.setData({
            toView: "0"
  ...
  navigatorClick: function(a) {
    var t = a.currentTarget.dataset.open_type,
    ...
    return "wxapp" != t || ((e = function(a) {
      var t = /([^&=]+)=([\w\W]*?)(&|$|#)/g,
        ...
        o = {};
      if (e && e[1])
        for (var d, p = e[1]; null != (d = t.exec(p));) o[d[1]] = d[2];
      return o
