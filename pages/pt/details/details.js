...
Page({
    ...
    onLoad: function(t) {
        getApp().page.onLoad(this, t);
        var e = t.user_id;
        if (void 0 !== e) e; else if (void 0 !== t) {
            t.uid && t.gid ? (t.uid, t.gid = t.gid) : t;
        } else if ("undefined" != typeof my && null !== getApp().query) {
            var o = getApp().query;
            getApp().query = null, t.id = o.gid;
        }
    ...
    // onLoad: function(t) {
    //     getApp().page.onLoad(this, t);
    //     var e = t.user_id, a = decodeURIComponent(t.path);
    //     if (void 0 !== e) e; else if (void 0 !== a) {
    //         var c = a.substring(25); //截取?号之后的字符串 --新增 (path=>"pages/pt/details/details?gid=123&uid=123")
    //         // var i = utils.scene_decode(a);
    ...
    onLoad1: function(query) { //待测试使用(改为query接收参数))
        ...
        var e = query.user_id, a = decodeURIComponent(query.path);
        if (void 0 !== e) e; else if (void 0 !== a) {
            var c = a.substring(25); //截取?号之后的字符串 --新增 (path=>"pages/pt/details/details?gid=123&uid=123")
            // var i = utils.scene_decode(a);
            var i = utils.scene_decode1(c);
            i.uid && i.gid ? (i.uid, query.gid = i.gid) : a;
        } else if ("undefined" != typeof my && null !== getApp().query) {
            var o = getApp().query;
            getApp().query = null, query.id = o.gid;
        }
        this.setData({
            id: query.gid,
            oid: query.oid ? query.oid : 0,
            group_checked: query.group_id ? query.group_id : 0
