...
Page({
  ...
  onShow: function(t) {
    ...
    a && (e.setData({
      ...
      name: a.name,
      mobile: a.mobile
    }), getApp().core.removeStorageSync(getApp().const.PICKER_ADDRESS), e.getInputData()), e.getOrderData(e.data.options)
  },
  onHide: function(t) {
    ...
    n.data.address && n.data.address.id && (e = n.data.address.id), t.goods_info && (getApp().core.showLoading({
      ...
      success: function(t) {
        if (getApp().core.hideLoading(), 0 == t.code) {
          ...
          if (2 == n.data.offline) var o = parseFloat(0 < e - t.data.colonel ? e - t.data.colonel : .01),
            s = 0;
          else o = parseFloat(0 < e - t.data.colonel ? e - t.data.colonel : .01) + t.data.express_price, s = parseFloat(t.data.express_price);
  ...
  orderSubmit: function(t) {
    ...
    e.data.goods_info && (a.goods_info = JSON.stringify(e.data.goods_info)), e.data.picker_coupon && (a.user_coupon_id = e.data.picker_coupon.user_coupon_id), e.data.content && (a.content = e.data.content), e.data.type && (a.type = e.data.type), e.data.parent_id && (a.parent_id = e.data.parent_id), a.payment = e.data.payment, a.formId = t.detail.formId, e.order_submit(a, "pt")
  },
  KeyName: function(t) {
    this.setData({
      name: t.detail.value
  ...
  getOffline: function(t) {
    var e = this,
      ...
      o = parseFloat(0 < e.data.res.total_price - e.data.res.colonel ? e.data.res.total_price - e.data.res.colonel : .01) + e.data.res.express_price;
    if (1 == a) this.setData({
      offline: 1,
