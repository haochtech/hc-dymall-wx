...
Page({
  ...
  getPreview: function (t) {
    ...
    getApp().request({
      ...
      success: function (t) {
        if (0 == t.code) {
          for (var e in t.data.form_list) "date" == t.data.form_list[e].type && (t.data.form_list[e].default || (t.data.form_list[e].default = utils.formatData(new Date), o.setData({
            is_date_start: !1
        ...
        if (0 == t.code) {
          ...
          void getApp().core.requestPayment({
            ...
            data: {
              ...
              sign: t.data.sign,
              sign_type: t.data.sign_type,
              timestamp: t.data.timestamp + "",
              trade_no: t.data.trade_no,
              risk_info: t.data.risk_info,
              merchant_id: t.data.merchant_id + "",
              uid: t.data.uid,
