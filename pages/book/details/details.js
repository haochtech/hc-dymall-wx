...
//   },
  ...
  onLoad: function(t) {
    ...
    if (void 0 !== e) e;
      ...
      t.uid && t.gid ? (t.uid, t.id = t.gid) : t
    } else if (null !== getApp().query) {
      var i = getApp().query;
      getApp().query = null, t.id = i.gid, i.uid
    }
  ...
  //   getApp().page.onLoad(this, t);
  //   var e = t.user_id,
  //     o = decodeURIComponent(t.path);
  //   if (void 0 !== e) e;
  //   else if (void 0 !== o) {
  //     var c = o.substring(27); //截取?号之后的字符串 --新增 (path=>"pages/book/details/details?gid=123&uid=123")
  //     // var a = utils.scene_decode(o);
  //     var a = utils.scene_decode1(c);
  //     a.uid && a.gid ? (a.uid, t.id = a.gid) : o
  //   } else if (null !== getApp().query) {
  //     var i = getApp().query;
  //     getApp().query = null, t.id = i.gid, i.uid
  ...
  onLoad1: function(query) { //待测试使用(改为query接收参数))
    getApp().page.onLoad(this, query);
    var e = query.user_id,
      o = decodeURIComponent(query.path);
    if (void 0 !== e) e;
    else if (void 0 !== o) {
      var c = o.substring(27); //截取?号之后的字符串 --新增 (path=>"pages/book/details/details?gid=123&uid=123")
      // var a = utils.scene_decode(o);
      var a = utils.scene_decode1(c);
      a.uid && a.gid ? (a.uid, query.id = a.gid) : o
    } else if (null !== getApp().query) {
      var i = getApp().query;
      getApp().query = null, query.id = i.gid, i.uid
    }
    this.setData({
      id: query.id
    }), p = 1, this.getGoodsInfo(query), this.getCommentList(!1)
  },
  ...
  onShow: function(t) {
    getApp().page.onShow(this), gSpecificationsModel.init(this), goodsBanner.init(this), goodsInfo.init(this), goodsBuy.init(this)
  },
  onHide: function(t) {
  ...
  onShareAppMessage: function(t) {
    ...
    var e = this,
      o = getApp().core.getStorageSync(getApp().const.USER_INFO);
    return {
    ...
    getApp().core.showLoading({
      ...
      success: function(t) {
        if (0 == t.code) {
          ...
          var a = t.data.info;
          a.num = t.data.info.stock, a.min_price = .01 < t.data.info.price ? t.data.info.price : "免费预约", a.price = .01 < t.data.info.price ? t.data.info.price : "免费预约", a.sales_volume = t.data.info.sales, a.service_list = t.data.info.service, i.setData({
            goods: t.data.info,
  ...
  getCommentList: function(e) {
    var o = this;
    e && "active" != o.data.tab_comment || is_loading_comment || (is_loading_comment = !0, getApp().request({
