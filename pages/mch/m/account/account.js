...
Page({
    ...
    onLoad: function (t) {
        ...
        o && a.setData(o), getApp().core.showLoading({ title: '请求中，请稍后...', }),

            getApp().request({
                url: getApp().api.mch.user.account,
                success: function (t) {
                    getApp().core.hideLoading(), 0 == t.code ? (a.setData(t.data), getApp().core.setStorageSync(e, t.data)) : getApp().core.showModal({
                        title: "提示",
                        content: t.msg,
                        success: function () { }
                    });
                ...
                getApp().core.showModal({
                    ...
                    success: function () {
                        0 == t.code && getApp().core.redirectTo({
                            url: "/pages/mch/m/account/account"
                        });
                    }
                });
            },
