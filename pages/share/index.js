...
Page({
  ...
  onShow: function() {
    ...
    var e = this,
      t = getApp().core.getStorageSync(getApp().const.SHARE_SETTING),
      a = e.data.__user_info;
    e.setData({
      share_setting: t,
  ...
  checkUser: function() {
    ...
    getApp().core.showLoading({
      ...
      success: function(e) {
        ...
        }), getApp().core.setStorageSync(getApp().const.CUSTOM, e.data.custom), t.loadData()), 1 == e.code && (__user_info.is_distributor = e.data.is_distributor, t.setData({
