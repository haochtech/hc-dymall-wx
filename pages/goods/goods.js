var WxParse = require("../../wxParse/wxParse.js"),
  ...
  goodsRecommend = require("../../components/goods/goods_recommend.js"),
  p = 1,
...
Page({
  ...
  onLoad: function (t) {
    ...
    // if ("undefined" == typeof my) {
    //   // var n = decodeURIComponent(t.scene);
    //   var n = decodeURIComponent(t.path);
    //   // var a = encodeURIComponent('pages/goods/goods'+'?gid=20&uid=356');
    //   // var b = decodeURIComponent(a);
    //   // var c = b.substring(18); //截取?号之后的字符串
    //   // var d = getApp().helper.scene_decode1(c);
    //   //   d.uid && d.gid && (t.id = d.gid)
    //   // console.log('c等于'+c);
    //   if (void 0 !== n) {
    //     var c = n.substring(18); //截取?号之后的字符串
    //     var d = getApp().helper.scene_decode1(c);
    //     console.log('哈哈哈'+d.uid+"|"+d.gid);
    //     d.uid && d.gid && (t.id = d.gid)
    //   }
    // } else if (null !== getApp().query) {
    //   console.log('啦啦啦');
  ...
  onLoad1: function (query) { //待测试使用(改为query接收参数))
    ...
    if ("undefined" == typeof my) {
      // var n = decodeURIComponent(t.scene);
      var n = decodeURIComponent(query.path);
      // var a = encodeURIComponent('pages/goods/goods'+'?gid=20&uid=356');
      // var b = decodeURIComponent(a);
      // var c = b.substring(18); //截取?号之后的字符串
      // var d = getApp().helper.scene_decode1(c);
      ...
      if (void 0 !== n) {
        ...
        var d = getApp().helper.scene_decode1(c);
        console.log('哈哈哈'+d.uid+"|"+d.gid);
        d.uid && d.gid && (query.id = d.gid)
      }
    } else if (null !== getApp().query) {
      console.log('啦啦啦');
      var c = getApp().query;
      getApp().query = null, query.id = c.gid
    }
  ...
  getCommentList: function (o) {
    var e = this;
    o && "active" != e.data.tab_comment || is_loading_comment || is_more_comment && (is_loading_comment = !0, getApp().request({
