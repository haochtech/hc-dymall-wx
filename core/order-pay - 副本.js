                ...
                if (0 == e.code) {
                  ...
                  tt.pay({
                    orderInfo: {
                      ...
                      subject: "懂车帝xx 活动测试",
                      body: "microapp test",
                      trade_time: e.data.timestamp,
                      valid_time: "300",
                      notify_url: "https://tp-pay-test.snssdk.com/cashdesk/test/paycallback",
                      // wx_url:
                      //   "https://wx.tenpay.com/cgi-bin/mmpayweb-bin/checkmweb?prepay_id=wx25161122572189727ea14cfd1832451500&package=2746219290",
                      // wx_type: "MWEB",
                      alipay_url: e.data.params,
                      // alipay_url:e.data.string,
                      sign: e.data.sign,
                    },
                    service: 4,
                    getOrderStatus(res) {
