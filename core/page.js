module.exports = {
  currentPage: null,
  currentPageOptions: {},
  navbarPages: ["pages/index/index", "pages/cat/cat", "pages/cart/cart", "pages/user/user", "pages/list/list", "pages/search/search", "pages/topic-list/topic-list", "pages/video/video-list", "pages/miaosha/miaosha", "pages/shop/shop", "pages/pt/index/index", "pages/book/index/index", "pages/share/index", "pages/quick-purchase/index/index", "pages/mch/m/myshop/myshop", "pages/mch/shop-list/shop-list", "pages/integral-mall/index/index", "pages/integral-mall/register/index", "pages/article-detail/article-detail", "pages/article-list/article-list", "pages/order/order"],
  onLoad: function (t, e) {
    this.currentPage = t,
    ...
    if (
      ...
      this.setBarTitle(),
      this.setNavi(),
      "function" == typeof t.onSelfLoad && t.onSelfLoad(e),
      o._setFormIdSubmit(),
      "undefined" != typeof my
      && "pages/login/login" != t.route && e && (t.options || (t.options = e),
        getApp().core.setStorageSync("last_page_options", e)),
      "lottery/goods/goods" == t.route && e
    ) {
      console.log('set')
    ...
    void 0 === t.mylogintt && (t.mylogintt = function (e) {
      o.mylogintt(e)
    })
  ...
  onShow: function (e) {
    ...
    if (this.currentPage = e, t.onShowData && t.onShowData.scene) {
      ...
      console.log(t.onShowData.scene)
    ...
    getApp().orderPay.init(e, getApp()),
      require("../components/quick-navigation/quick-navigation.js").init(this.currentPage)
  },
  onHide: function (e) {
    this.currentPage = e
  },
  ...
  setParentId: function (e) {
    ...
    if ("/pages/index/index" == t.route && this.setOfficalAccount(), e) {
      ...
      o && void 0 !== o && (getApp().core.setStorageSync(getApp().const.PARENT_ID, o), getApp().trigger.remove(getApp().trigger.events.login, "TRY_TO_BIND_PARENT"), getApp().trigger.add(getApp().trigger.events.login, "TRY_TO_BIND_PARENT", function () {
        t.bindParent({
          parent_id: o,
          condition: 0
        })
  ...
  setPageNavbar: function (s) {
    ...
    // console.log(e, this.currentPage, c.navbarPages)
    e && n(e);
    var t = !1;
    for (var o in c.navbarPages)
      if (p.__route__ == c.navbarPages[o]) {
        t = !0;
        break
      }
  ...
  setBarTitle: function (e) {
    var t = this.currentPage.__route__,
  ...
  setNavigationBarColor: function () {
    ...
    e && (getApp().core.navigationBarBackgroundColor(e),
      t.setData({
        _navigation_bar_color: e
      })), getApp().navigateBarColorCall = function (e) {
        getApp().core.navigationBarBackgroundColor(e.data), t.setData({
  ...
  _setFormIdSubmit: function (e) {
    ...
    g._formIdSubmit || (g._formIdSubmit = function (e) {
      ...
      switch (console.log("form_id"),
      "the formId is a mock one" === o || getApp().helper.inArray(o, c) || (s.push({
        time: getApp().helper.time(),
        form_id: o
      }),
        getApp().core.setStorageSync(getApp().const.FORM_ID_LIST, s)),
      console.log(i),
      i = i == 'mch/m/myshop/myshop' ? '/pages/mch/m/myshop/myshop' : i,
      g[n] && "function" == typeof g[n] && g[n](e), a) {
        case "navigate":
  ...
  mylogintt() {
    ...
    getApp().core.login({
      success: function (e) {
        console.log("login", e)
        var t = e.code,anonymousCode=e.anonymousCode;
        tt.getUserInfo({
          success(res) {
            ...
            that.unionLogin({
              ...
              encrypted_data: "",
              signature: "8a5fc5e05d21a42d2fdd2f5c9dce279b02fce157",
              iv: 'XI8Ha3eGZW4XjCIPDCu0nw==',
              wechat_app: '111',
            })
          },
          fail(res) {
            ...
            getApp().core.getSetting({
                success: function(e) {
                    e.authSetting["scope.userInfo"] ?"" : getApp().getauth({
                        content: "需要获取您的用户授权，请到小程序设置中打开授权！",
                        cancel: !1,
                        author: "scope.userInfo",
                        success: function(e) {
    ...
    //   avatarUrl: "https://wx.qlogo.cn/mmopen/vi_32/hDibwguIM2NLXTkByhia6FsAbYmcm6vVPonHPoDDKZPMOFy3ZRSq9oREibkKDeQYOzyZCCkCKQpR0sOJXic3PRX3sw/132"
    // }
    // this.unionLogin({
    //   code: "043yeKqi18CgMv0T9hri1Cs0ri1yeKqb",
    //   user_info: JSON.stringify(a),
    //   encrypted_data: "",
    //   signature: "8a5fc5e05d21a42d2fdd2f5c9dce279b02fce157",
    //   iv: 'XI8Ha3eGZW4XjCIPDCu0nw==',
    // })
  ...
  myLogin: function () {
    console.log('e')
    var t = this;
    "my" === getApp().platform && (console.log(getApp().login_complete), getApp().login_complete || (getApp().login_complete = !0, my.getAuthCode({
      scopes: "auth_user",
      success: function (e) {
        t.unionLogin({
          code: e.authCode
