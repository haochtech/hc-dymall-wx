var platform = null;
// "undefined" != typeof tt && (platform = "tt"), 
"undefined" != typeof tt && (platform = "tt"), 
...
var modules = [{
  ...
  args = {
    ...
    onLaunch: function() {
     let o = this.core;
      this.getStoreData()
      // o.setStorageSync("XhSzgQsLiGfug2ImpvdJkpLX807NFyKe")
    },
    onShow: function(e) {
      console.log(e)
...
console.log(t,"tttttttt")
      0 == t.code && (o.setStorageSync(s.const.STORE, t.data.store), 
      o.setStorageSync(s.const.STORE_NAME, t.data.store_name), 
      o.setStorageSync(s.const.SHOW_CUSTOMER_SERVICE, t.data.show_customer_service), 
